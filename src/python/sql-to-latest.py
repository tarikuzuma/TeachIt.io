...
# Execute the SQL query to select data from the "thread" table and sorting by their latest time of upload
mycursor.execute("SELECT * FROM thread ORDER BY date_upload DESC")

# Fetch all the rows from the result set
result = mycursor.fetchall()

# BRUTE FORCEFULLY sorts the result by the highest latest date of upload hence "Latest"
